    ...
    <div class="max-w-md w-full space-y-8 bg-white p-8 rounded-xl shadow-lg">
      ...
      <form @submit.prevent="handleLogin" class="mt-8 space-y-6">
        ...
        <div class="flex items-center justify-between">
          <div class="text-sm">
            <button type="button" @click="$emit('forgot-password')" class="font-medium text-blue-600 hover:text-blue-500">
        ...
        <div class="text-center text-sm">
          ...
          <button type="button" @click="$emit('switch-to-signup')" class="font-medium text-blue-600 hover:text-blue-500">
            Sign up
          </button>
        </div>
      </form>
...
const emit = defineEmits(['switch-to-signup', 'forgot-password'])
