<template>
  <Teleport to="body">
    <div 
      v-if="isOpen" 
      @click="closeModal"
      class="fixed inset-0 z-50 overflow-y-auto flex items-center justify-center transition-opacity duration-300 bg-black/50"
    >
      <div 
        @click.stop 
        class="bg-white rounded-xl shadow-2xl w-full max-w-3xl m-4 md:m-8 p-6 transform transition-all duration-300"
      >
        ...
        <form @submit.prevent="handleSubmit" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div class="lg:col-span-4 grid grid-cols-1 md:grid-cols-4 gap-4">
            <div class="col-span-full md:col-span-1">
              <label for="edit-jobTitle" class="block text-sm font-medium text-gray-700">
            ...
            <div class="col-span-full md:col-span-1">
              <label for="edit-company" class="block text-sm font-medium text-gray-700">
            ...
            <div class="col-span-full md:col-span-1">
              <label for="edit-dateApplied" class="block text-sm font-medium text-gray-700">
          ...
          <div class="lg:col-span-4 grid grid-cols-1 md:grid-cols-4 gap-4">
            <div>
              <label for="edit-jobLink" class="block text-sm font-medium text-gray-700">
                Job Link (URL)
              </label>
              <input 
            ...
            <div>
              <label for="edit-salary" class="block text-sm font-medium text-gray-700">
                Salary/Compensation
              </label>
              <input 
            ...
            <div>
              <label for="edit-location" class="block text-sm font-medium text-gray-700">
                Location
              </label>
              <input 
            ...
            <div>
              <label for="edit-nextActionDate" class="block text-sm font-medium text-gray-700">
                Next Action Date
              </label>
              <input 
...
const handleSubmit = () => {
  ...
  showToast('Application updated successfully', 'green')
